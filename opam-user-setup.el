...
;; ## added by OPAM user-setup for emacs / tuareg ## 50e1ceee2a8df0f0eae70a5aeeba0f3a ## you can edit, but keep this line
...
(defun opam-tuareg-autoload (fct file doc args)
  (let ((load-path (cons "/Users/neatonk/.opam2/4.06.1/share/emacs/site-lisp" load-path)))
    (load file))
  (apply fct args))
...
;; ## added by OPAM user-setup for emacs / ocp-indent ## b61c7ac841219d40f818fcdb66e974ce ## you can edit, but keep this line
;; Load ocp-indent from its original switch when not found in current switch
(when (not (assoc "ocp-indent" opam-tools-installed))
  (autoload 'ocp-setup-indent "/Users/neatonk/.opam2/4.06.1/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Tuareg mode")
  (autoload 'ocp-indent-caml-mode-setup "/Users/neatonk/.opam2/4.06.1/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Caml mode")
  (add-hook 'tuareg-mode-hook 'ocp-setup-indent t)
  (add-hook 'caml-mode-hook 'ocp-indent-caml-mode-setup  t)
  (setq ocp-indent-path "/Users/neatonk/.opam2/4.06.1/bin/ocp-indent"))
